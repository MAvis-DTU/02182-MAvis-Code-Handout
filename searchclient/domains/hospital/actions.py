...
class PushAction:
    ...
    def is_applicable(self, agent_index,  state):
        ...
        return box_char != '' and \
               state.level.colors[box_char] == state.level.colors[agent_char] and \
               state.free_at(new_box_position)
...
class PullAction:
    ...
    def is_applicable(self, agent_index,  state):
        ...
        return box_char != '' and \
               state.level.colors[box_char] == state.level.colors[agent_char] and \
               state.free_at(new_agent_position)
...
ROBOT_ACTION_LIBRARY = DEFAULT_MAPF_ACTION_LIBRARY
